...
std::future<MessageBoxResult> MessageBox::show(Window *parent, std::string_view title,
...
std::future<MessageBoxResult> MessageBox::information(Window *parent, std::string_view title,
    ...
    return show(parent, title, message, MessageBoxIcon::Information, MessageBoxButtons::Ok);
}

std::future<MessageBoxResult> MessageBox::warning(Window *parent, std::string_view title,
                                                  std::string_view message) {
    return show(parent, title, message, MessageBoxIcon::Warning, MessageBoxButtons::Ok);
}

std::future<MessageBoxResult> MessageBox::error(Window *parent, std::string_view title,
                                                std::string_view message) {
    return show(parent, title, message, MessageBoxIcon::Error, MessageBoxButtons::Ok);
}

std::future<MessageBoxResult> MessageBox::question(Window *parent, std::string_view title,
                                                   std::string_view message) {
    return show(parent, title, message, MessageBoxIcon::Question, MessageBoxButtons::YesNo);
}
