...
class MacOSCairoPlatformApplication : public MacOSPlatformApplicationBase {
  public:
...
class MacOSCairoPlatformWindow : public PlatformWindow {
  public:
    MacOSCairoPlatformWindow(std::string_view title, Size size, Window *owner);
    ~MacOSCairoPlatformWindow() override;
    void show() override;
    void close() override;
