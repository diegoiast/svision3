...
// Generic "no icon available" placeholder, in the same spirit as Qt/X11's
// own long-standing default window icon -- the classic X11.app/XQuartz
// logo mark (black X crossed through an orange ring) -- rather than
// anything meant to look like actual SVision3 branding.
