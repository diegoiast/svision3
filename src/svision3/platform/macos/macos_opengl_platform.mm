...
#include "svision3/painters/gl_offscreen.hpp"
...
@implementation TKGLView {
    svision3::CoreTextRasterizer rasterizer_;
}
...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    svision3::GLPainter painter(h, scale, &rasterizer_);
...
- (svision3::Point)tkPoint:(NSEvent *)event {
