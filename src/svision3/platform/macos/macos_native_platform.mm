...
@property(nonatomic, assign) svision3::Window *owner;
@end
...
@property(nonatomic) svision3::Color bgColor;
@property(nonatomic) svision3::Color borderColor;
@property(nonatomic) svision3::Color textColor;
...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    svision3::CoreGraphicsPainter painter(ctx, &s_mac_rasterizer);
    svision3::Rect r{0, 0, static_cast<float>(bounds.size.width),
...
- (svision3::Point)convertMouseEvent:(NSEvent *)event {
...
- (void)mouseDown:(NSEvent *)event {
    ...
    svision3::MouseEvent e;
    e.type = svision3::MouseEvent::Type::Press;
    e.position = pos;
    e.button = 0;
...
- (void)mouseUp:(NSEvent *)event {
    auto pos = [self convertMouseEvent:event];
    svision3::MouseEvent e{svision3::MouseEvent::Type::Release, pos, 0};
    self.owner->handle_mouse(e);
}

- (void)rightMouseUp:(NSEvent *)event {
    auto pos = [self convertMouseEvent:event];
    svision3::MouseEvent e{svision3::MouseEvent::Type::Release, pos, 1};
    self.owner->handle_mouse(e);
}

- (void)otherMouseUp:(NSEvent *)event {
    auto pos = [self convertMouseEvent:event];
    svision3::MouseEvent e{svision3::MouseEvent::Type::Release, pos,
...
- (void)mouseMoved:(NSEvent *)event {
    auto pos = [self convertMouseEvent:event];
    svision3::MouseEvent e{svision3::MouseEvent::Type::Move, pos, 0};
    self.owner->handle_mouse(e);
}
...
- (void)mouseDragged:(NSEvent *)event {
    auto pos = [self convertMouseEvent:event];
    svision3::MouseEvent e{svision3::MouseEvent::Type::Move, pos, 0};
    e.type = svision3::MouseEvent::Type::Drag;
    self.owner->handle_mouse(e);
}
...
- (void)scrollWheel:(NSEvent *)event {
    auto pos = [self convertMouseEvent:event];
    svision3::MouseEvent e{};
    e.type = svision3::MouseEvent::Type::Scroll;
    e.position = pos;
...
- (void)sendTabKey:(BOOL)shift {
    ...
    svision3::KeyEvent ke;
    ke.type = svision3::KeyEvent::Type::Press;
    ke.key = svision3::Key::Tab;
    ke.shift = shift;
...
- (void)keyDown:(NSEvent *)event {
    ...
    case 49:
        ke.key = svision3::Key::Space;
        break;
    case 51:
        ke.key = svision3::Key::Backspace;
        break;
    case 117:
        ke.key = svision3::Key::Delete;
        break;
    case 123:
        ke.key = svision3::Key::Left;
        break;
    case 124:
        ke.key = svision3::Key::Right;
        break;
    case 125:
        ke.key = svision3::Key::Down;
        break;
    case 126:
        ke.key = svision3::Key::Up;
        break;
    case 115:
        ke.key = svision3::Key::Home;
        break;
    case 119:
        ke.key = svision3::Key::End;
        break;
    case 116:
        ke.key = svision3::Key::PageUp;
        break;
    case 121:
        ke.key = svision3::Key::PageDown;
        break;
    case 36:
        ke.key = svision3::Key::Enter;
        break;
    case 53:
        ke.key = svision3::Key::Escape;
        break;
    case 122:
        ke.key = svision3::Key::F1;
        break;
    case 120:
        ke.key = svision3::Key::F2;
        break;
    case 99:
        ke.key = svision3::Key::F3;
        break;
    case 118:
        ke.key = svision3::Key::F4;
        break;
    case 96:
        ke.key = svision3::Key::F5;
        break;
    case 97:
        ke.key = svision3::Key::F6;
        break;
    case 98:
        ke.key = svision3::Key::F7;
        break;
    case 100:
        ke.key = svision3::Key::F8;
        break;
    case 101:
        ke.key = svision3::Key::F9;
        break;
    case 109:
        ke.key = svision3::Key::F10;
        break;
    case 103:
        ke.key = svision3::Key::F11;
        break;
    case 111:
        ke.key = svision3::Key::F12;
        break;
    ...
    if (chars.length > 0 && ke.key == svision3::Key::NoKey) {
        unichar c = [chars characterAtIndex:0];
        if (c >= 32 && c < 127) {
            ke.text = [chars UTF8String];
        }
    }
    if (ke.super && ke.key == svision3::Key::Left) {
        ke.key = svision3::Key::Home;
    }
    if (ke.super && ke.key == svision3::Key::Right) {
        ke.key = svision3::Key::End;
    }
    self.owner->handle_key(ke);
}
